...
//using array and only 3  can be opened at a time try npm start again
...
function App2() {
 ...
 function showGrades(clickedID){
  ...
  let newClickedCardID =[...clickedCardID];
      ...
      else if(newClickedCardID.length>=maximumAllowedOpen){
        newClickedCardID.splice(0,3)
